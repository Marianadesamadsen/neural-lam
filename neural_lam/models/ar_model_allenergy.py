...
import sys 
sys.path.insert(0,"./")
from integrate_sphere.compute_energy_batch import compute_energy_over_time
from integrate_sphere.compute_energy_batch import surface_mass_integration
...
class ARModel(pl.LightningModule):
    ...
    def __init__(
        ...
        self.energy_out = surface_mass_integration(N=6, generation=4, R=1)
